...
Por ejemplo dentro de las pantallas mas usuales dentro de una tienda tenemos las de incio la del carrito y la de procesamiento de pago alguna que tambien se tiene que destacar es la de inventario. La importancia de tener un frontend limpio y llamativo es mucha ya que es con lo que intractua el usuario siempre que 